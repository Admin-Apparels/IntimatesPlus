...
const FooterAchieves = () => {
  return (
    <Grid 
      ...
      userSelect={"none"}
    >
      <GridItem colSpan={{ base: 6, md: 2 }} h='auto' bg='tomato' p={4} borderRadius={4}>
        <Box fontSize={"small"}>
          ...
          Research suggests that by 2030, a significant percentage of women aged 30-40 may
           ...
           to changing social dynamics and higher standards set by social media,
            read the research <Link p={1} color="blue.500" href="https://www.quora.com/With-the-news-50-of-women-being-single-and-childless-by-2030-why-are-men-rejecting-most-women-and-what-can-lonely-women-do-to-improve" target="_blank" rel="noopener noreferrer">here.</Link>
          </Text>
          <Text> 
          ...
          read the research <Link p={1} color="blue.500" href="https://www.psychologytoday.com/intl/blog/why-bad-looks-good/202109/the-link-between-pornography-and-loneliness" target="_blank" rel="noopener noreferrer">here.</Link>
          </Text>
        </Box>
      </GridItem>
      ...
      <Text>
      For more information, join our <Link p={1} color="blue.500" href="https://x.com/IntiMates_Plus">X forum</Link> 
      or email: <strong>intimates_plus@fuckmate.boo</strong>. Support us with donations <Link color="blue.500" href="https://www.paypal.com/donate/?hosted_button_id=2L8HHGURQTED2">here</Link>. Stay 
